                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            Active Channels</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="activeChannels">0</div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                            Live Streams</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="liveStreams">0</div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-lg-8">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Stream Activity</h6>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <div id="recentActivity">
                                    <div class="activity-item">
                                        ...
                                        <span>Stream started: Channel 1</span>
